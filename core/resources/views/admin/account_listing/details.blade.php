            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between">
                            <span class="text--muted">@lang('Client / Buyer')</span>
                        ...
                        @if($accountListing->url)
                        <li class="list-group-item d-flex justify-content-between">
                            <span class="text--muted">@lang('Portfolio / Website URL')</span>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            <span class="text--muted">@lang('Instructions / Delivery Details')</span>
                            <h6>{{ @$accountListing->accountCredential->others_info ?? __('No additional instructions provided.') }}</h6>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <span>@lang('Reject Service Listing')</span>
                    </h5>
...
<button class="btn btn-outline--success confirmationBtn" data-action="{{ route('admin.account.listing.approve.status', $accountListing->id) }}" data-question="@lang('Are you sure to approve this service listing')?" type="button">
