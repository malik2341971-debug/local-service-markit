            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-7 ps-lg-5">
                    <div class="product-details__right">
                        ...
                        @endif
                        <div class="mb-3 mt-3">
                            <h6 class="mb-0 fs-16">@lang('Service Specifications')</h6>
                        ...
                        <div class="mb-3">
                            ...
                            <span class="current-bid-style fs-18 fw-bold">{{ showAmount($accountListing->sell_price) }}</span>
                        </div>
                        <form action="{{ route('user.direct.payment') }}" method="post">
                            ...
                            <button class="btn btn--base w-100 py-2 fs-16" name="submit_type" type="submit" value="buy">
                                <i class="fas fa-shopping-bag me-1"></i> @lang('Order Service Now')
                            </button>
                        </form>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="related-product">
                        <h4 class="related-product__title"> @lang('Related Services') </h4>
                        @forelse ($relatedAccounts as $accountListing)
                            @include($activeTemplate . 'partials.product_item')
                        @empty
                            @include($activeTemplate . 'empty', [
                                'message' => 'There are no related services found',
                            ])
                        @endforelse
                    </div>
                </div>
