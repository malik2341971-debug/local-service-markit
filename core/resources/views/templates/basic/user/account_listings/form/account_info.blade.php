            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        <h2 class="section-heading__title mb-3"> @lang('Service Specifications') </h2>
                        <p class="section-heading__desc m-auto">
                            @lang('Provide specific details and technical parameters about your service.') </p>
                    </div>
                </div>
            </div>
            <div class="row gx-0">
                            ...
                            <div class="social-media__check form-group">
                                <div class="form--check">
                                    ...
                                    <label class="form-check-label" for="verified">
                                        @lang('Verified Quality / Guaranteed Service')
                                    </label>
                                </div>
                            </div>
