            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        <h2 class="section-heading__title mb-3"> @lang('Publish Service') </h2>
                        <p class="section-heading__desc m-auto"> @lang('Review your details and submit your service for live listing on the marketplace.') </p>
                    </div>
                </div>
            </div>
            <div class="row gx-0">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == 'success') {
                            notify('success', "@lang('Service published successfully')");
