            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        <h2 class="section-heading__title mb-3"> @lang('Cover Image & Portfolio Media') </h2>
                        <p class="section-heading__desc m-auto">
                            @lang('Upload a primary service cover photo and showcase high quality images or samples of your previous work.')
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="social-media__body">
                        <form id="urlImageForm">
                            <div class="form-group">
                                <label class="form--label">@lang('Primary Service Cover Image')</label>
                                <x-image-uploader name="thumbnail_image" type="account_listing_thumb" image="{{$accountListing->thumbnail_image }}" :required=false />
                            </div>
                            <div class="form-group">
                                <label class="form--label">@lang('Portfolio & Work Samples')</label>
                                <div>
