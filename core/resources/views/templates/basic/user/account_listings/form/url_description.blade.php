            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-heading">
                        <h2 class="section-heading__title mb-3"> @lang('Portfolio URL & Service Description') </h2>
                        <p class="section-heading__desc m-auto">
                            @lang('Provide a clear service title, an optional portfolio link, and a detailed description of what your service includes.') </p>
                    </div>
                </div>
            </div>
            <div class="row gx-0">
                        ...
                        <form id="urlDescriptionForm">
                            <div class="form-group">
                                ...
                                <input class="form--control" name="title" type="text"
                                    value="{{ old('title', $accountListing->title) }}" placeholder="@lang('e.g. Professional Local Plumbing & Repair Service')" required>
                            </div>
                            <div class="form-group">
                                <label class="form--label"> @lang('Portfolio / Website URL') </label>
                                <input class="form--control" name="url" type="url"
                                    value="{{ old('url', $accountListing->url) }}" placeholder="https://example.com/portfolio" required>
                            </div>
                            <div class="form-group">
                                <label class="form--label" for="description"> @lang('Full Service Description & Scope') </label>
