        ...
        <div class="container">
            ...
            <div class="row gy-4">
                    ...
                    <div class="dashboard-item">
                        <div class="dashboard-item__content">
                            <a class="dashboard-item__title" href="{{ route('user.account.listing.index') }}">
                                @lang('My Listed Services') </a>
                            <h3 class="dashboard-item__currency"> {{ $totalListingCount }} </h3>
                        </div>
                        <span class="dashboard-item__icon"> <i class="fas fa-concierge-bell"></i> </span>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="dashboard-item">
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="dashboard-item">
                        <div class="dashboard-item__content">
                            <a class="dashboard-item__title" href="{{ route('user.withdraw.history') }}"> @lang('Total Withdraw') </a>
